  ...
  return (
    <>
      ...
      <div className="container mx-auto mt-20 flex flex-col items-center">
        <Paragraphe title="Qui suis-je ?" image={benji} className="mb-10">
        ...
        <Button size="60">Mes vidéos</Button>
        <Paragraphe title="Ce que je propose" image={piano} right className="mt-20 mb-10">
          Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor 
          incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud 
          exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute 
          irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. 
        ...
        <div className="w-full flex justify-around">
          <Button size="60">Mes tarifs</Button>
