...
const App = () => {
  ...
  return (
    <>
      <Navbar />
      <Banner />
      <div id="presentation" className="container mx-auto mt-20 flex flex-col items-center">
      ...
      <div id="pricing" className="container mx-auto flex flex-col items-center">
        <PricingCard title="Cours d'une heure" price1="25€" price2="20€" className="mb-20"/>
        <PricingCard title="Cours d'une demie-heure" price1="15€" price2="13€" className="mb-10"/>
        <div className="w-full">Forfait de 10 cours d'une heure : 200€</div>
        <div className="w-full">Forfait de 10 cours d'une demie-heure : 130€</div>
        <Button className="mt-10 mb-20" size="60" primary>Je réserve un cours</Button>
      </div>
